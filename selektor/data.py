...
def build_data(trainfname, devfname, testfname, qcol, acol, lcol, extract_feature):
    """
    ...
    if extract_feature:
        stopwords_fname = os.path.join(dir, '../data/short-stopwords.txt')
        feature_extractor = Feature(trainfname, devfname, testfname, qcol, stopwords_fname)
